...
// defaultRefPatterns covers the namespaces the TUI renders. refs/notes,
// refs/pull, refs/stash, etc. are intentionally excluded — they aren't
// surfaced anywhere in the cockpit.
